  ...
  return (
    <Fragment>
      ...
      >
        ...
        <MenuItemStyled sx={{ p: 0 }} onClick={() => handleDropdownClose(PATH_DASHBOARD.userAccount.profile)}>
          <Box sx={styles}>
            <Icon icon='tabler:user-check' />
            My Profile
          </Box>
        </MenuItemStyled>
        <MenuItemStyled sx={{ p: 0 }} onClick={() => handleDropdownClose(PATH_DASHBOARD.settings.accountSettings)}>
          <Box sx={styles}>
