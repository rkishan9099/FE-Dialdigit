...
const FileUploaderSingle = () => {
  ...
  const img = files.map(file => (
    <Image key={file.name} alt={file.name} className='single-file-image' src={URL.createObjectURL(file)} />
  ))
...
const FileUploaderSingle = () => {
  ...
  const img = files.map((file: FileProp) => (
    <Image key={file.name} alt={file.name} className='single-file-image' src={URL.createObjectURL(file as any)} />
  ))
